...
public class Testprogramm_2 {
    public static void main(String[] args) {
        ...
        moenchengladbach.addEdge(new Edge(viersen, 10))
                .addEdge(new Edge(erkelenz, 17));
        //Heinsberg und Düsseldorf sind von hier aus nicht mehr zu erreichen
        ...
        Vertex[] destinations = {heinsberg, duesseldorf};

        //Berechnung der Pfade
        Dijkstra.computePaths(moenchengladbach, true);
